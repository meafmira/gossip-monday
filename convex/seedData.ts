export const initialMembers = [
  {
    ...
    funFact:
      'Может превратить бытовую историю в архитектурную диаграмму с рисками и зависимостями.',
    canLetIn: true,
    avatar: 'ОН',
    color: '#111827',
    sortOrder: 0,
  ...
  },
  {
    ...
    funFact:
      'Если две случайности выглядят слишком случайно — Юлия уже открыла investigation thread.',
    canLetIn: false,
    avatar: 'ЮБ',
    color: '#f97316',
    sortOrder: 2,
...
export const initialReports = [
  {
    ...
    outcomes: [
      'Официально признали, что “потом расскажу” — это не статус, а угроза.',
      'Назначили следующий gossip backlog на ланч.',
      'Зафиксировали: без свидетеля история считается trailer-ом.',
    ],
    sortOrder: 0,
  },
];

export const initialGalleryEvents = [
  {
    seedId: 'e1',
